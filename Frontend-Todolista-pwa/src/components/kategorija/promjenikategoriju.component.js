...
export default class PromijeniKategoriju extends Component {

  constructor(props) {
    super(props);

    this.kategorija = this.dohvatiKategoriju();
    this.PromijeniKategoriju= this.PromijeniKategoriju.bind(this);
